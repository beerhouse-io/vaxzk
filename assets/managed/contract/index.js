  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      registerInvite: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`registerInvite: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const result_0 = this._registerInvite_0(context,
                                                partialProofData,
                                                secret_0);
