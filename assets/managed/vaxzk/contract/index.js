...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      adminOnlyAction: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`adminOnlyAction: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._adminOnlyAction_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      clinicOnlyAction: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`clinicOnlyAction: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('clinicOnlyAction',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const result_0 = this._clinicOnlyAction_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      addClinic: (...args_1) => {
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('clinicOnlyAction', new __compactRuntime.ContractOperation());
  ...
  _adminOnlyAction_0(context, partialProofData) {
    this._isAdmin_0(context, partialProofData); return [];
  }
  _clinicOnlyAction_0(context, partialProofData) {
    const _sk_0 = this._localSk_0(context, partialProofData);
    const pubKey_0 = this._publicKey_0(_sk_0);
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
