...
export type ImpureCircuits<PS> = {
  ...
  adminOnlyAction(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, []>;
  clinicOnlyAction(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, []>;
