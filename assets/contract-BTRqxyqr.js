...
let __tla = Promise.all([
    ...
    f(`0.15.0`);
    var x = new o(32), S = _, C = new s(65535n, 2), w = new m(2, x), T = new s(18446744073709551615n, 8);
    new class {
        alignment() {
    ...
    D = class {
        ...
        constructor(...e){
            ...
            this.witnesses = n, this.circuits = {
                ...
                adminOnlyAction: (...e)=>{
                    if (e.length !== 2) throw new t(`adminOnlyAction: expected 2 arguments (as invoked from Typescript), received ${e.length}`);
                    let n = e[0], r = e[1];
                    typeof n == `object` && n.currentQueryContext != null || u(`adminOnlyAction`, `argument 1 (as invoked from Typescript)`, `vaxzk.compact line 44 char 1`, `CircuitContext`, n), typeof r == `bigint` && r >= 0n && r <= 65535n || u(`adminOnlyAction`, `argument 1 (argument 2 as invoked from Typescript)`, `vaxzk.compact line 44 char 1`, `Uint<0..65536>`, r);
                    let i = {
                        ...n,
                        gasCost: h()
                    }, a = {
                        ...
                        publicTranscript: [],
                        privateTranscriptOutputs: []
                    }, o = this._adminOnlyAction_0(i, a, r);
                    return a.output = {
                        value: [],
                        alignment: []
                    }, {
                ...
                addClinic: (...e)=>{
                    ...
                    let n = e[0], r = e[1];
                    typeof n == `object` && n.currentQueryContext != null || u(`addClinic`, `argument 1 (as invoked from Typescript)`, `vaxzk.compact line 49 char 1`, `CircuitContext`, n), r.buffer instanceof ArrayBuffer && r.BYTES_PER_ELEMENT === 1 && r.length === 32 || u(`addClinic`, `argument 1 (argument 2 as invoked from Typescript)`, `vaxzk.compact line 49 char 1`, `Bytes<32>`, r);
                    let i = {
                        ...n,
                        gasCost: h()
                    }, a = {
                ...
                revokeClinic: (...e)=>{
                    ...
                    let n = e[0], r = e[1];
                    typeof n == `object` && n.currentQueryContext != null || u(`revokeClinic`, `argument 1 (as invoked from Typescript)`, `vaxzk.compact line 58 char 1`, `CircuitContext`, n), r.buffer instanceof ArrayBuffer && r.BYTES_PER_ELEMENT === 1 && r.length === 32 || u(`revokeClinic`, `argument 1 (argument 2 as invoked from Typescript)`, `vaxzk.compact line 58 char 1`, `Bytes<32>`, r);
                    let i = {
                        ...n,
                        gasCost: h()
                    }, a = {
        ...
        initialState(...n) {
            ...
            s = s.arrayPush(r.newNull()), s = s.arrayPush(r.newNull()), o.data = new c(s), o.setOperation(`addAdmin`, new i), o.setOperation(`revokeAdmin`, new i), o.setOperation(`adminOnlyAction`, new i), o.setOperation(`addClinic`, new i), o.setOperation(`revokeClinic`, new i);
        ...
        _localSk_0(e, t) {
            let n = g(O(e.currentQueryContext.state), e.currentPrivateState, e.currentQueryContext.address), [r, i] = this.witnesses.localSk(n);
    ...
    A = {
        publicKey: (...e)=>{
            ...
            let n = e[0];
            return n.buffer instanceof ArrayBuffer && n.BYTES_PER_ELEMENT === 1 && n.length === 32 || u(`publicKey`, `argument 1`, `vaxzk.compact line 10 char 1`, `Bytes<32>`, n), k._publicKey_0(n);
        }
    };
    j = {
...
export { D as Contract, j as contractReferenceLocations, O as ledger, A as pureCircuits, __tla };
